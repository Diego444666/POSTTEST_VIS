...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        MenuStrip1.Items.AddRange(New ToolStripItem() {mnuData, mnuDashboard, mnuKeluar})
        ...
        ' lblKet
        ' 
        lblKet.Font = New Font("Segoe UI", 9F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
